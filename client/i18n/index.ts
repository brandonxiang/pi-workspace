...
const translations = {
  en: {
    ...
    "settings.pluginsTitle": "Pi plugins",
    "settings.pluginsHelp":
      "Configured Pi packages from global and project settings. Plugins can execute local code.",
    "settings.pluginsRefresh": "Refresh",
    "settings.pluginsRefreshing": "Refreshing…",
    "settings.pluginsUpdate": "Update packages",
    "settings.pluginsUpdating": "Updating…",
    "settings.pluginsUpdateDone": "Packages updated.",
    "settings.pluginsUpdateFailed": "Package update failed",
    "settings.pluginsUpdatePermissionMissing":
      "Missing package update permission. Reload the plugins list and try again.",
    "settings.pluginsLoading": "Loading configured plugins…",
    "settings.pluginsEmpty": "No configured Pi plugins found.",
    "settings.pluginsFiltered": "filtered",
    "settings.pluginsEnabled": "enabled",
    "settings.pluginsDiagnostics": "Diagnostics",
    "settings.archivedChatTitle": "Archived chats",
    "settings.archivedChatEmpty": "No archived chats yet.",
    "settings.skillsEmpty": "No configured skills found.",
    "settings.skillsHelp":
      "Global skills loaded from agent config directories. Skills define specialized workflows and tooling.",
    "settings.skillsLoading": "Loading skills…",
    "settings.skillsOriginPackage": "Package",
    "settings.skillsOriginTopLevel": "Top-level",
    "settings.skillsRefresh": "Refresh",
    "settings.skillsRefreshing": "Refreshing…",
    "settings.skillsScopeUser": "Global",
    "settings.skillsTitle": "Installed skills",
  ...
  "zh-CN": {
    ...
    "settings.tabPlugins": "Plugins",
    "settings.pluginsTitle": "Pi 插件",
    "settings.pluginsHelp": "来自全局和项目设置的 Pi package。插件可能执行本地代码。",
    "settings.pluginsRefresh": "刷新",
    "settings.pluginsRefreshing": "正在刷新…",
    "settings.pluginsUpdate": "更新扩展包",
    "settings.pluginsUpdating": "正在更新…",
    "settings.pluginsUpdateDone": "扩展包已更新。",
    "settings.pluginsUpdateFailed": "扩展包更新失败",
    "settings.pluginsUpdatePermissionMissing": "缺少扩展包更新权限,请刷新插件列表后重试。",
    "settings.pluginsLoading": "正在加载已配置的插件…",
    "settings.pluginsEmpty": "没有找到已配置的 Pi 插件。",
    "settings.pluginsFiltered": "已筛选",
    "settings.pluginsEnabled": "已启用",
    "settings.pluginsDiagnostics": "诊断信息",
    "settings.archivedChatTitle": "已归档对话",
    "settings.archivedChatEmpty": "暂时没有已归档对话。",
    "settings.skillsEmpty": "没有找到已配置的技能。",
    "settings.skillsHelp": "从 agent 配置目录加载的全局技能。技能定义专门的工作流和工具。",
    "settings.skillsLoading": "正在加载技能…",
    "settings.skillsOriginPackage": "Package",
    "settings.skillsOriginTopLevel": "Top-level",
    "settings.skillsRefresh": "刷新",
    "settings.skillsRefreshing": "正在刷新…",
    "settings.skillsScopeUser": "全局",
    "settings.skillsTitle": "已安装技能",
